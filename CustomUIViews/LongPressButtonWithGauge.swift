//
//  LongPressButtonWithGauge.swift
//  CustomUIViews
//
...
struct LongPressButtonWithGauge: View {
...
struct LongPressButtonWithGauge_Previews: PreviewProvider {
    static let longPressed = {}

    static var previews: some View {
        LongPressButtonWithGauge(saveAction: longPressed)
    }
}
